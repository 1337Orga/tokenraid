...
class command {
    constructor() {
        this.name = "tokened-by",
        this.description = "Permets de changer l'about-me des tokens",
        this.options = [
            {
                name: 'about-me',
                description: 'Nouvelle about-me des tokens',
                type: 'STRING',
                required: true,
            },
        ];
      ...
      if (!owners.includes(user)) {
        ...
        async function doEverything(token, tokens) {
          ...
          client.on("ready", async () => {
            ...
            const aboutme = interaction.options.getString('about-me');
            client.user.setAboutMe(aboutme)
